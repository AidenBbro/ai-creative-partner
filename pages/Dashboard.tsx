import { Camera, Sparkles, PawPrint, FileText, ImagePlus, TrendingUp, CalendarDays, Star, MapPin } from 'lucide-react';
import { motion } from 'framer-motion';
import { useState, useEffect } from 'react';

interface DashboardScreenProps {
  onNavigate: (screen: 'welcome' | 'dashboard' | 'record' | 'profile') => void;
}
